...
local email_recent_from = wibox.widget {
	-- text = 'From:',
	font = beautiful.theme .. ' 10',
	markup = '<span font="' .. beautiful.theme_bold .. ' 10">From: </span>loading@stdout.sh',
	align = 'left',
	valign = 'center',
	widget = wibox.widget.textbox
}
...
local email_recent_subject = wibox.widget {
	markup = '<span font="' .. beautiful.theme_bold .. ' 10">Subject: </span>Loading data',
	-- font = beautiful.theme .. ' 10',
	align = 'left',
	valign = 'center',
	widget = wibox.widget.textbox
...
return function (s, enclose)
	return build_widget(email_report, enclose)
end
