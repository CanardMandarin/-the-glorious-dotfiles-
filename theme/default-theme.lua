...
-- Font
theme.font = 'SF Pro Text Regular'
theme.font_bold = 'SF Pro Text Bold'
theme.font_light = 'SF Pro Text UltraLight'

theme.title_font = 'SF Pro Text Bold 14'

theme.icon_theme = 'Tela-blue-dark' -- Menu icon theme
theme.accent = '#6498EF' -- Accent color
theme.background = '#2C2F33' .. '66' -- Background color
theme.transparent = '#00000000' -- Transparent
...
local awesome_overrides = function(theme)
	...
	theme.dock_bg = theme.background
